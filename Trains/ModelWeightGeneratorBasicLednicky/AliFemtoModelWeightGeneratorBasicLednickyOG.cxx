...
Double_t AliFemtoModelWeightGeneratorBasicLednicky::GenerateWeight(AliFemtoPair *aPair)
{
  ...
  if(tPart1 != NULL && tPart2 != NULL)
  {
    ...
    if(tPart1HiddenInfo != NULL && tPart2HiddenInfo != NULL)
    {
      ...
      fKStar = 0.5*sqrt(tQinvSq);

      if(fKStar == 0) return 0;  //a KStar value of zero break the Lednicky weight generator (bc of 1/z term)
      ...
      Double_t tWeight = GetLednickyWeight();
      return tWeight;
    }
