...
//aodxi->ResetXi();
//cout << "\t\t\t\t\t\t\t\tDcaXiToPrimVertex = " << aodxi->DcaXiToPrimVertex() << endl << endl << endl;
...
*/
  ...
  //v0
  //tFemtoXi->SetdecayLengthV0(tAODxi->DecayLength(fV1));  //why?! NO!
//----------------------------------------------------------
/*
cout << "In AliFemtoEventReaderAOD::CopyAODtoFemtoXi" << endl;

cout << "For reference, tAODxi->DecayLengthXi(fV1[0],fV1[1],fV1[2]) = " << tAODxi->DecayLengthXi(fV1[0],fV1[1],fV1[2]) << endl;

cout << "\t\t\t\tMETHOD1: tAODxi->DecayLength(fV1) = " << tAODxi->DecayLength(fV1) << endl;
cout << "\t\t\t\tMETHOD2: tAODxi->DecayLengthV0() " << tAODxi->DecayLengthV0() << endl;
...
cout << "\t\t\t\tMETHOD3: tAODxi->DecayLength(temp) " << tAODxi->DecayLength(temp) << endl << endl;
*/
//----------------------------------------------------------
  ...
  AliFemtoThreeVector decayvertex(tAODxi->DecayVertexV0X(), tAODxi->DecayVertexV0Y(), tAODxi->DecayVertexV0Z());
  tFemtoXi->SetdecayVertexV0(decayvertex);
  ...
  AliFemtoThreeVector mompos(tAODxi->MomPosX(), tAODxi->MomPosY(), tAODxi->MomPosZ());
  tFemtoXi->SetmomPos(mompos);

  tFemtoXi->SetmomNegX(tAODxi->MomNegX());
  tFemtoXi->SetmomNegY(tAODxi->MomNegY());
  tFemtoXi->SetmomNegZ(tAODxi->MomNegZ());
  AliFemtoThreeVector momneg(tAODxi->MomNegX(), tAODxi->MomNegY(), tAODxi->MomNegZ());
  tFemtoXi->SetmomNeg(momneg);

  tFemtoXi->SetmomV0X(tAODxi->MomV0X());
  tFemtoXi->SetmomV0Y(tAODxi->MomV0Y());
  tFemtoXi->SetmomV0Z(tAODxi->MomV0Z());
  AliFemtoThreeVector momv0(tAODxi->MomV0X(), tAODxi->MomV0Y(), tAODxi->MomV0Z());
  tFemtoXi->SetmomV0(momv0);
  ...
  tFemtoXi->SetEtaV0(tAODxi->Eta());
  tFemtoXi->SetPhiV0(tAODxi->Phi());
